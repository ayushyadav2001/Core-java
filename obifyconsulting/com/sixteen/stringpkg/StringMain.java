package com.obifyconsulting.com.sixteen.stringpkg;
...
public class StringMain {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(a1==a2);//false - a1 and a2 references are pointing to diff objects
        System.out.println(a1.equals(a2));//true - equals only checks the values
        String s1 = "John";
        String s2 = "John";
        ...
        System.out.println(one.startsWith("This", 5));//false-check if This starts at 5th index
        System.out.println(one.startsWith("is", 5));//true-check if is starts at 5th index
        ...
        */System.out.println(a.contains(b));
        ...
        if(option4.toUpperCase().equals("Y"))
        {
